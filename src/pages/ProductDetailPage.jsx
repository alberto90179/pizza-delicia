...
function ProductDetailPage() {
    ...
    const handleAddToCart = () => {
        ...
        alert(`¡${product.title} (${selectedSize || 'Unidad'}) agregado al carrito!`);
        setQuantity(1);
    };
        ...
        <div className="product-detail-page-container page-padding">
            ...
            <div className="product-detail-main">
                ...
                <div className="product-detail-info">
                    ...
                    <p className="product-price-display">${currentPrice} MXN</p>
                    ...
                    {/* Input de Cantidad */}
                    <div className="quantity-input-container" style={{ marginBottom: '20px' }}>
            ...
            <section className="suggestions-section">
                <h2>Sugerencias para agregar a tu pedido</h2>
